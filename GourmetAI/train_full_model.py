...
MODEL_PATH = r"c:\antigravity\mlfr\rating_predictor.pkl"
SCALER_PATH = r"c:\antigravity\mlfr\scaler.pkl"
...
def train_production_model():
    print("[INFO] Connecting to full dataset engine...")
    ...
    if df_sample.empty:
        print("❌ Error: Database is empty. Please execute db_init_full.py first.")
        conn.close()
        return
    ...
    print("Starting incremental LightGBM training...")
    while True:
        query = f"""
            SELECT r.cooking_time,
                   r.ingredients,
    ...
    print(f"[OK] Successfully saved rating_predictor.pkl and scaler.pkl to your workspace.")
